...
var visualize = function() {
  ...
  var margin = { top: 45, right: 50, bottom: 20, left: 100 };
  ...
  var color = d3.scaleLinear()
    .domain([0, 100])
    .range(['hsla(30, 96%, 52%, 0.5)', 'hsla(229, 96%, 33%, 0.5)'])
  ...
  var x_axis = d3.axisTop(x)
    ...
    .ticks(ticks);
  svg.append('g').attr('class', 'axis-small').call(x_axis);
  ...
  var tip = d3.tip().attr('class', 'd3-tip').html(function(d) {
    return "<b>" + d.word + "</b> was perceived to be <b>" + d.value + "</b> people." +
