...
// chart metadata
var charts = {
  'tests-Big10-Nebraska-testPositivity': {
    self: 'tests-Big10-Nebraska-testPositivity',
    id: "chart-tests-Big10-Nebraska-testPositivity",

    dataSourceNeeded: 'countries',
    reducer: reducer_byCountry,
    scale: "linear",
    highlight: "Nebraska",
    defaultHighlight: "Nebraska",
    y0: 100,
    xCap: 25,
  ...
  'tests-Big10-OhioState-cases': {
    self: 'tests-Big10-OhioState-cases',
    id: "chart-tests-Big10-OhioState-cases",
...
var _f_load_allSuccess = function () {
  ...
  _dateObj_today = convertDateToObject("2020-09-16");
...
var getAttribution = function(chart) {
  ...
  return `Data Retrieved: ${_dateUpdated}`;
...
var doRender = function(chart, isInAnimation = false, target = chart.id) {
  ...
  */
  ...
  svg.append("text")
    ...
    .style("font-size", "8px")
    .style("fill", "#aaa")
    .text(`Data Source: COVID-19 Among Big Ten Conference Schools (@profwade_)`);
